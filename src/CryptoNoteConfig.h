...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3678 // addresses start with "iZ";
...
const char     CRYPTONOTE_NAME[]                             = "iZNDCoin";
...
const int      P2P_DEFAULT_PORT                              = 7711;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 17711;
